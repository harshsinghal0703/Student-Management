...
urlpatterns = [
    ...
    path('doLogout',views.doLogut, name = 'logout'),
    ...
    path('Hod/Staff/Edit<str:id>',Hod_Views.EDIT_SATFF, name = 'edit_staff'),
    ...
    path('Staff/View_Attendance',Staff_Views.STAFF_VIEW_ATTENDANCE,name = 'staff_view_attandance'),
